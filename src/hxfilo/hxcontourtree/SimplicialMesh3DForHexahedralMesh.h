...
public:
    ...
    void getGridPos(std::vector<McVec3i>& gridPos) const;
    void getGridPos(const std::vector<mclong>& vertexIds,
...
private:
    ...
    float m_bbox[6];
    mculong m_numNodes;
    std::vector<mclong> m_mapNodeToMeshVertex;
    std::vector<mclong> m_mapMeshVertexToNode;
