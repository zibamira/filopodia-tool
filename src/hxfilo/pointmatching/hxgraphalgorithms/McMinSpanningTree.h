...
public:
    ...
    bool computeMinSpanningTreeFHeap(const std::vector<McVec2i> & edges,
                                     const std::vector<T> & weight,
                                     int nVertices,
                                     std::vector<int> & edgeIdOfMST);
    /** Same as above, only that for finding the next edge with
        ...
        function. */
    bool computeMinSpanningTreeQSort(const std::vector<McVec2i> & edges, 
                                     const std::vector<T> & weight, 
                                     int nVertices, 
                                     std::vector<int> & edgeIdOfMST);
...
bool McMinSpanningTree<T>::computeMinSpanningTreeFHeap(
                                         const std::vector<McVec2i> & edges,
                                         const std::vector<T> & weight,
                                         int nVertices,
                                         std::vector<int> & edgeIdsOfMST)
{
    McFHeap<McMSTHeapElement<T> > fheap;
    std::vector<McMSTHeapElement<T> > heapElements(edges.size());
    int i;
    ...
    std::vector<McMSTVertex> vertices(nVertices);
