...
void 
PointMatchingScoringFunction::setScoreDivisor(const std::vector<int> & numPoints1, 
                                              const std::vector<int> & numPoints2)
{
    scoreDivisor = 0.0f;
    
    for (size_t i=0; i<numPoints1.size() && i<numPoints2.size(); i++ ) {
...
double
PointMatchingScoringFunction::computeScore(const std::vector<double> & squaredDists)
{
    sumSquaredDists = 0.0f;
