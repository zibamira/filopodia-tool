...
void 
SimplePointRepresentation3d::setCoords(const std::vector<McVec3f> & coords)
{
    this->coords = coords;
        ...
        std::vector<McBitfield>              & connected) const
{
    ...
    const std::vector<std::vector<double> > & distMatrix2 = pointSet2->getDistMatrix();
						...
						double & squaredEdgeWeight) const
{
    ...
    const std::vector<McVec3f> & coords2 = simpleCacheObject->getCoords();
